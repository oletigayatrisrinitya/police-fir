...
public class AppUserController {
	...
	//private AppUserEntity addUser;
	@PostMapping("/add")
	public AppUserEntity addUser(@RequestBody AppUserEntity entity) {
		AppUserEntity addUser= this.service.addUser(entity);
		return addUser;
	}
	@PostMapping("/create")
	public AppUserEntity createUser(@RequestBody AppUserEntity entity) {
		AppUserEntity createUser= this.service.createUser(entity);
		return createUser;
	}
	@PutMapping("/update")
	...
	public List<AppUserEntity> getAllUser(){
		List<AppUserEntity>allUser =this.service.getAllUser();
		return allUser;
		}
	//Get All Users By Id
	@GetMapping("/get")
	public List<AppUserEntity> getAllUserById() {
		List<AppUserEntity> userbyid=this.service.getAllUser();
		return userbyid;
		}
	//Lodge Complaint
	@PutMapping("/addc")
